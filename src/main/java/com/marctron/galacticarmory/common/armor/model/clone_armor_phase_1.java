...
public class clone_armor_phase_1  extends HumanoidModel<LivingEntity>  {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("galacticarmory", "clone_armor_phase_1.json"), "main");
    ...
    public clone_armor_phase_1(ModelPart root) {
        ...
        this.rightThigh = this.right_leg.getChild("rightThigh");
        this.rightKnee = this.right_leg.getChild("rightKnee");
        ...
        this.rightShin = this.right_leg.getChild("rightShin");
        this.left_leg = root.getChild("left_leg");
        this.leftThigh = this.left_leg.getChild("leftThigh");
        this.leftKnee = this.left_leg.getChild("leftKnee");
        ...
        this.leftShin = this.left_leg.getChild("leftShin");
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition shirt = body.addOrReplaceChild("shirt", CubeListBuilder.create().texOffs(28, 1).addBox(-4.0F, 9.0F, -2.0F, 8.0F, 3.0F, 4.0F, new CubeDeformation(0.0039F))
                .texOffs(24, 51).addBox(-4.0F, 5.0F, -2.0F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.0078F))
                .texOffs(34, 42).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 5.0F, 4.0F, new CubeDeformation(0.0039F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition belt = body.addOrReplaceChild("belt", CubeListBuilder.create().texOffs(0, 0).addBox(-4.5F, -1.0F, -2.5F, 9.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
                .texOffs(0, 22).addBox(-4.75F, -1.4F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(22, 10).addBox(3.75F, -1.4F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 9.5F, 0.0F));
        ...
        PartDefinition crotch = body.addOrReplaceChild("crotch", CubeListBuilder.create().texOffs(22, 26).addBox(-3.5F, -13.8812F, -2.25F, 7.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(25, 12).addBox(-1.0F, -12.5F, -2.35F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0078F)), PartPose.offset(0.0F, 24.0F, 0.0F));
        ...
        PartDefinition stomach = body.addOrReplaceChild("stomach", CubeListBuilder.create().texOffs(8, 47).addBox(-5.0F, -3.0F, -0.35F, 8.0F, 3.0F, 2.0F, new CubeDeformation(0.05F))
                .texOffs(0, 59).addBox(-5.0F, -3.5F, -0.35F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.045F)), PartPose.offset(1.0F, 8.5F, -1.65F));
        ...
        PartDefinition chestplate = body.addOrReplaceChild("chestplate", CubeListBuilder.create(), PartPose.offset(0.0F, 4.0F, 0.0F));
        ...
        PartDefinition back = body.addOrReplaceChild("back", CubeListBuilder.create(), PartPose.offset(0.0F, 2.0F, 2.0F));
        ...
        PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(8, 31).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0078F)), PartPose.offset(-2.0F, 12.0F, 0.0F));

        PartDefinition rightThigh = right_leg.addOrReplaceChild("rightThigh", CubeListBuilder.create().texOffs(36, 33).addBox(-2.05F, -0.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.25F))
                .texOffs(38, 18).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0156F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition rightKnee = right_leg.addOrReplaceChild("rightKnee", CubeListBuilder.create().texOffs(24, 31).addBox(-2.0F, -1.25F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.075F)), PartPose.offset(0.0F, 6.0F, 0.0F));
        ...
        PartDefinition rightShin = right_leg.addOrReplaceChild("rightShin", CubeListBuilder.create().texOffs(16, 74).addBox(-2.0F, 6.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0156F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(8, 31).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0078F)).mirror(false), PartPose.offset(2.0F, 12.0F, 0.0F));

        PartDefinition leftThigh = left_leg.addOrReplaceChild("leftThigh", CubeListBuilder.create().texOffs(36, 33).mirror().addBox(-1.95F, -0.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.25F)).mirror(false)
                .texOffs(38, 18).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0156F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition leftKnee = left_leg.addOrReplaceChild("leftKnee", CubeListBuilder.create().texOffs(24, 31).mirror().addBox(-2.0F, -1.25F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.075F)).mirror(false), PartPose.offset(0.0F, 6.0F, 0.0F));
        ...
        PartDefinition leftShin = left_leg.addOrReplaceChild("leftShin", CubeListBuilder.create().texOffs(16, 74).mirror().addBox(-2.0F, 6.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0156F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int colour) {
        ...
        //this.leftBoot.render(poseStack, vertexConsumer, packedLight, packedOverlay, colour);
        //this.rightBoot.render(poseStack, vertexConsumer, packedLight, packedOverlay, colour);
    }
