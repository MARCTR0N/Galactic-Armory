...
public class ArmorAssemblerMenu extends AbstractContainerMenu {
    public final ArmorAssemblerBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public ArmorAssemblerMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public ArmorAssemblerMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenus.ARMOR_ASSEMBLER_MENU.get(), pContainerId);
        this.blockEntity = ((ArmorAssemblerBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.ARMOR_ASSEMBLER_BLOCK.get());
    }
